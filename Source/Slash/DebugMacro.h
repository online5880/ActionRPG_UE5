...
#define DRAW_POINT(Location) if(GetWorld()) if (GetWorld()) DrawDebugPoint(GetWorld(), Location, 15.f, FColor::Red, true);
#define DRAW_POINT_SingleFrame(Location) if(GetWorld()) if (GetWorld()) DrawDebugPoint(GetWorld(), Location, 15.f, FColor::Red, false,-1);  
